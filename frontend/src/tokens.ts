/* ══════════════════════════════════════════════════════════════════════
   TOKENS — les polices, propres au web (voir @leclub/core pour la
   palette, partagée). Seul fichier à toucher pour changer les polices.
   ══════════════════════════════════════════════════════════════════════ */

import { HATCH_COLORS as H, HATCH_STRIPE } from '@leclub/core';
...
/** Motif hachuré qui sert d'avatar et de pièce jointe dans tout le design.
    Les couleurs et le pas viennent de @leclub/core, partagés avec le
    <Hatch> SVG de mobile. */
